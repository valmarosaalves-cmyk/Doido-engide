package subStates; // CORRIGIDO: Com 'S' maiúsculo como o erro pediu
...
// Se o motor não tem 'backend', as classes estão na raiz ou em pastas simples
...
class PauseSubState extends MusicBeatSubstate
{
    ...
    public function new()
    {
        ...
        // Texto da Música (Rádio)
        // Removido o 'states.' pois seu motor parece não usar subpastas
    ...
    override function update(elapsed:Float)
    {
        ...
        // Corta o texto dentro do quadrado
        ...
        if (controls.ACCEPT)
        {
            ...
            switch (daChoice)
            {
                ...
                case 'Exit to Menu':
                    ...
                    // Se der erro aqui, mude para MainMenuState puro
